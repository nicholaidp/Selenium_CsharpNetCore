...
{
    internal class Encoder : DriverHelper
    {
        [SetUp]
        public void Setup()
        {
        ...
        public void Test()
        {
            ...
            txtUsername.SendKeys("encoder@revlv.com");
            ...
            for (int i = 0; i < loopCounter; i++)
            {
                ...
                randomExhibitor = RandomGenerator.generateExhibitor();
                ...
                Driver.FindElement(By.Id("input_exhibit_time")).SendKeys("1129PM");

                #region Exhibitor
                IWebElement txtExhibitor = Driver.FindElement(By.Id("input-exhibitor"));
                txtExhibitor.SendKeys(randomExhibitor);
                txtExhibitor.SendKeys(Keys.Down);
                txtExhibitor.SendKeys(Keys.Enter);
                #endregion

                #region Name
                Driver.FindElement(By.Id("input_salutation")).SendKeys(randomSalutations);
                Driver.FindElement(By.Id("input_first_name")).SendKeys("En1-" + randomFname);
